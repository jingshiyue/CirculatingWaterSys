...
class Device_run_state(models.Model):
    ...
    diyaSwitch = models.IntegerField(verbose_name='低压开关')
    gaoYaBeng = models.IntegerField(verbose_name='高压泵')
    chongxiFa = models.IntegerField(verbose_name='冲洗阀')
    chouYangQi = models.IntegerField(verbose_name='臭氧器')
    remoteSwitch = models.IntegerField(verbose_name='远程开关')
