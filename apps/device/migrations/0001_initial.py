# Generated by Django 2.2 on 2020-10-27 07:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Device_run_state',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('wenKongSwitch', models.IntegerField(verbose_name='温控开关')),
                ('dev_state', models.CharField(blank=True, choices=[(0, '出厂'), (1, '正常制水'), (2, '冲洗'), (3, '水满'), (4, '缺水'), (5, '臭氧'), (6, '清洗前置罐'), (10, '参数设置失败'), (11, '正常制水'), (12, '冲洗'), (13, '水满'), (14, '缺水'), (15, '臭氧'), (16, '清洗前置罐'), (20, '无原水'), (21, '低压'), (30, '无原水'), (31, '低压')], max_length=2, null=True, verbose_name='设备状态')),
                ...
                ('device_id', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='device.Device', verbose_name='设备ID')),
            ],
            options={
                'verbose_name': '设备运行状态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='device.Device', verbose_name='设备号')),
            ],
            options={
