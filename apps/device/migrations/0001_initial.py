    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(blank=True, max_length=50, verbose_name='备注名称')),
                ('online', models.IntegerField(choices=[(0, '离线'), (1, '在线'), (2, '未知')], default='未知', verbose_name='是否离线')),
                ('arg_set_state', models.CharField(blank=True, max_length=50, verbose_name='参数设置是否成功')),
                ('temperature', models.FloatField(blank=True, max_length=10, verbose_name='温度')),
                ('signal', models.FloatField(blank=True, max_length=10, verbose_name='信号')),
                ('chunShui', models.IntegerField(default=0, verbose_name='纯水')),
                ('yuanShui', models.IntegerField(default=0, verbose_name='原水')),
                ('zhiShuiTime', models.IntegerField(default=0, verbose_name='制水时间')),
                ('zhiShuiTotalTime', models.IntegerField(default=0, verbose_name='制水累计')),
            ],
            options={
                'verbose_name': '设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repair', models.CharField(blank=True, max_length=20, verbose_name='报修状态')),
                ('reportMan', models.CharField(blank=True, max_length=20, verbose_name='报修人员')),
                ...
                ('repairAddr', models.CharField(blank=True, max_length=20, verbose_name='维修地点')),
                ('descErorr', models.CharField(blank=True, max_length=20, verbose_name='故障简述')),
                ('runErrorTime', models.DateTimeField(verbose_name='故障日期')),
                ('repairMan', models.CharField(blank=True, max_length=20, verbose_name='上门维修人员')),
                ('repairManPhone', models.CharField(blank=True, max_length=20, verbose_name='维修人员电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dev_state', models.CharField(blank=True, choices=[(0, '出厂'), (1, '正常制水'), (2, '冲洗'), (3, '水满'), (4, '缺水'), (5, '臭氧'), (6, '清洗前置罐'), (10, '参数设置失败'), (11, '正常制水'), (12, '冲洗'), (13, '水满'), (14, '缺水'), (15, '臭氧'), (16, '清洗前置罐'), (20, '无原水'), (21, '低压'), (30, '无原水'), (31, '低压')], max_length=2, verbose_name='设备状态')),
